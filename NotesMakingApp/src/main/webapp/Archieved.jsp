<html>
    <head>
        ...
        <link rel="stylesheet" href="Web-css/Archieved.css">
        					...
        					if(l>2){
        						let obj = $.parseJSON(data);
   						 		$.each(obj,function(key,value){//0,1,2
   						 			...
   						 			const options = '<ul class="tasks-stored-options"><li><a href="#">'+archieveIcon+'</a></li><li><a href="#">'+deleteIcon+'</a></li></ul><button><i class="fa fa-angle-left" aria-hidden="true"></i></button>';
...
<%-- <html>
    ...
    <body>
        <div class="content">
            <h1>Sorry! currently no Archieved tasks are to view</h1>
            <img src="https://iconarchive.com/download/i18743/iconshock/real-vista-project-managment/task-notes.ico" alt="no image">
        </div>
    </body>
</html> --%>